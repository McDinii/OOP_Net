...
namespace Laba_05
{
    public abstract class CarManagment : TransportVehicle // абстрактный класс
    {
        public string? Model;
        ...
        protected CarManagment(int countPassengers, string? model, Engine engine, double weight) : base(countPassengers)
        {
            Model = model;
            Engine = engine;
            Weight = weight;
